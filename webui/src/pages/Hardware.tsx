...
// Mock data for Hardware page
const depainNodes = [
  { name: 'High-Performance Node', specs: '32GB RAM, 8 cores', type: 'DePAIN' },
  { name: 'Secure Enclave Node', specs: '16GB RAM, 4 cores', type: 'Enclave' }
]

const meshNetworks = [
  { name: 'Urban Mesh Network', nodes: 45, type: 'BATMAN' },
  { name: 'Rural Coverage Mesh', nodes: 32, type: 'CJDNS' }
]

const tutorials = [
  { title: 'Build a DePAIN Node', level: 'Intermediate', duration: '60 min' },
  { title: 'Set Up a Mesh Network', level: 'Advanced', duration: '90 min' },
  { title: 'Secure Enclaves for Infra', level: 'Advanced', duration: '75 min' }
]

const deploymentGuides = [
  { title: 'Deploy a DePIN Mesh on Autheo', level: 'Advanced', duration: '50 min' },
  { title: 'Secure Your Hardware Enclave', level: 'Intermediate', duration: '45 min' }
]

const marketplaceItems = [
  { name: 'DePAIN Node Kit', price: '$1000', type: 'Hardware' },
  { name: 'Mesh License', price: '$200/year', type: 'License' }
]

// Hero image URL - using a local placeholder image
const heroImageUrl = '/hardware-hero-image.png'
    ...
    <div className="space-y-8 animate-fade-in">
      ...
      <div className="glass-card p-4 mb-4 relative">
        <div className="flex items-center gap-4">
          <div className="relative flex-1">
            <input
              type="text"
              placeholder="Search for DePIN nodes, meshes, or hardware kits"
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex gap-2">
              ...
              <span className="text-xs bg-background/40 text-white px-2 py-1 rounded-md">Capacity</span>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div className="glass-button py-2 px-3 text-sm flex items-center justify-center">
                    <span className="text-white">DePAIN Nodes</span>
                  </div>
                  <div className="glass-button py-2 px-3 text-sm flex items-center justify-center">
                    <span className="text-white">Mesh Networks</span>
                  </div>
                  <div className="glass-button py-2 px-3 text-sm flex items-center justify-center">
                    <span className="text-white">Hardware Kits</span>
                  </div>
                  <div className="glass-button py-2 px-3 text-sm flex items-center justify-center">
                    <span className="text-white">Secure Enclaves</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <div className="glass-card p-0 mb-8 relative overflow-hidden">
        ...
        <div className="relative z-10 p-8">
          <h1 className="text-2xl md:text-3xl lg:text-4xl font-bold text-white mb-2">
            Build Physical Infra on Autheo
          </h1>
          <p className="text-lg text-white/90 mb-2">
            324 DePIN Projects, 89 Networks Deployed, 15 Secured Enclaves
          </p>
          <p className="text-md text-muted-foreground mb-4">
            Power DePAIN Now!
          </p>
          <div className="flex flex-col sm:flex-row gap-4 mt-6">
            <Link to="/hardware/deploy" className="glass-button py-3 px-6 flex items-center justify-center group">
              Deploy Hardware
              <span className="ml-2 transform transition-transform group-hover:translate-x-1">→</span>
            </Link>
            <Link to="/hardware/manage" className="glass-button py-3 px-6 flex items-center justify-center group">
              Manage Nodes
              <span className="ml-2 transform transition-transform group-hover:translate-x-1">→</span>
            </Link>
          </div>
          ...
          <div className="glass-card p-6 min-h-[450px] flex flex-col justify-between">
            ...
            <div className="mb-6">
              ...
              <div className="grid grid-cols-2 gap-2 mb-4">
                <div className="glass-button py-2 px-3 text-sm flex items-center justify-center">
                  <span className="text-white">Autheo Hardware SDK</span>
                </div>
                <div className="glass-button py-2 px-3 text-sm flex items-center justify-center">
                  <span className="text-white">BATMAN</span>
                </div>
                <div className="glass-button py-2 px-3 text-sm flex items-center justify-center">
                  <span className="text-white">CJDNS</span>
                </div>
                <div className="glass-button py-2 px-3 text-sm flex items-center justify-center">
                  <span className="text-white">DePIN Node Templates</span>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              {toolsExpanded && (
                <div className="space-y-2 text-sm mb-4">
                  <p className="text-muted-foreground">• Node deployment scripts</p>
                  <p className="text-muted-foreground">• Mesh configuration</p>
          ...
          <div className="glass-card p-6 min-h-[450px] flex flex-col justify-between">
            ...
            <div className="mb-6">
              ...
              <p className="text-sm text-muted-foreground mb-3">
                Buy DePIN hardware, mesh kits, or DPT for infra staking.
              </p>
                ...
                <>
                  ...
                  <div className="mb-4">
                    ...
                    <p className="text-xs text-muted-foreground">
                      Includes staking rewards for hardware providers
                    </p>
                  </div>
                </>
              )}
              ...
              {dashboardExpanded && (
                <div className="space-y-4">
                  <div className="activity-item">
                    <Server className="w-4 h-4 text-primary/60" />
                    <div className="flex-1">
                      <p className="font-medium text-white">Infrastructure Monitoring</p>
                      <p className="text-sm text-muted-foreground">
                        Monitor node uptime, mesh health, and infra performance
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="activity-item">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Automated scaling, AI-driven load balancing, and DPT staking analytics
                      </p>
                    </div>
                  </div>
                  ...
                  <div className="activity-item">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-muted-foreground">
                        Alerts for hardware failures, network issues, and reward payouts
                      </p>
                    </div>
                  </div>
                </div>
      ...
      <div className="glass-card p-6 mt-8">
        <div className="flex flex-wrap justify-center gap-x-8 gap-y-4">
          ...
          <Link to="/hardware/support" className="text-white hover:text-primary transition-colors">
            Support
          </Link>
        </div>
      </div>
